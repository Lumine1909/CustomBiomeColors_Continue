...
public class ServerDataHandler_26_1 implements ServerDataHandler<Biome, Holder<Biome>, ResourceKey<Biome>> {
    ...
    public BiomeAccessor<Biome, Holder<Biome>, ResourceKey<Biome>> getBiomeFromKey(BiomeKey biomeKey) {
        ...
        return new BiomeAccessor_26_1(BIOME_REGISTRY.get(ResourceKey.create(Registries.BIOME, Identifier.fromNamespaceAndPath(biomeKey.key(), biomeKey.value()))).orElseThrow());
    }
