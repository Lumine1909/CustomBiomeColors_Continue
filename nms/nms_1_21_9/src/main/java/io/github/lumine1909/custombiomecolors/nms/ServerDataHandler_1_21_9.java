...
public class ServerDataHandler_1_21_9 implements ServerDataHandler<Biome, Holder<Biome>, ResourceKey<Biome>> {
    ...
    public BiomeAccessor<Biome, Holder<Biome>, ResourceKey<Biome>> getBiomeFromKey(BiomeKey biomeKey) {
        ...
        return new BiomeAccessor_1_21_9(BIOME_REGISTRY.get(ResourceKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath(biomeKey.namespace(), biomeKey.value()))).orElseThrow());
    }
    ...
    public boolean hasBiome(BiomeKey biomeKey) {
        return BIOME_REGISTRY.get(ResourceKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath(biomeKey.namespace(), biomeKey.value()))).isPresent();
    }
    ...
    public BiomeAccessor<Biome, Holder<Biome>, ResourceKey<Biome>> createCustomBiome(BiomeData biomeData, boolean register) {
        ...
        return register
            ? new BiomeAccessor_1_21_9(this.registerBiome(holder, customBiome, resourceKey), biomeData)
            : new BiomeAccessor_1_21_9(customBiome, biomeData);
    }
