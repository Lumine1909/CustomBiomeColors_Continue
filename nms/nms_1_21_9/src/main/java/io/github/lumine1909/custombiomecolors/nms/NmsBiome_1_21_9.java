...
public class NmsBiome_1_21_9 extends NmsBiome<Biome, Holder<Biome>, ResourceKey<Biome>> {

    public NmsBiome_1_21_9(Holder<Biome> biomeHolder) {
        this(biomeHolder, fetchNmsBiomeData(biomeHolder));
    }

    public NmsBiome_1_21_9(Holder<Biome> biomeHolder, BiomeData cachedData) {
    ...
    public NmsBiome<Biome, Holder<Biome>, ResourceKey<Biome>> cloneWithDifferentColor(NmsServer<Biome, Holder<Biome>, ResourceKey<Biome>> nmsServer, BiomeKey newBiomeKey, ColorData colorData) {
        ...
        return new NmsBiome_1_21_9(holder, new BiomeData(newBiomeKey, this.cachedData.baseBiomeKey(), colorData));
    }
