...
public class ServerDataHandler_1_21_4 implements ServerDataHandler<Biome, Holder<Biome>, ResourceKey<Biome>> {
    ...
    public BiomeAccessor<Biome, Holder<Biome>, ResourceKey<Biome>> getBiomeFromKey(BiomeKey biomeKey) {
        ...
        return new BiomeAccessor_1_21_4(BIOME_REGISTRY.get(ResourceKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath(biomeKey.namespace(), biomeKey.value()))).orElseThrow());
    }
    ...
    public BiomeAccessor<Biome, Holder<Biome>, ResourceKey<Biome>> createCustomBiome(BiomeData biomeData, boolean register) {
        ...
        return register
            ? new BiomeAccessor_1_21_4(this.registerBiome(holder, customBiome, resourceKey), biomeData)
            : new BiomeAccessor_1_21_4(customBiome, biomeData);
    }
