...
public class ServerDataHandler_1_21_3 implements ServerDataHandler<Biome, Holder<Biome>, ResourceKey<Biome>> {
    ...
    public BiomeAccessor<Biome, Holder<Biome>, ResourceKey<Biome>> getBiomeFromKey(BiomeKey biomeKey) {
        ...
        return new BiomeAccessor_1_21_3(BIOME_REGISTRY.get(ResourceKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath(biomeKey.namespace(), biomeKey.value()))).orElseThrow());
    }
    ...
    public BiomeAccessor<Biome, Holder<Biome>, ResourceKey<Biome>> createCustomBiome(BiomeData biomeData, boolean register) {
        ...
        return register
            ? new BiomeAccessor_1_21_3(this.registerBiome(holder, customBiome, resourceKey), biomeData)
            : new BiomeAccessor_1_21_3(customBiome, biomeData);
    }
