...
public class BiomeAccessor_1_21_3 extends BiomeAccessor<Biome, Holder<Biome>, ResourceKey<Biome>> {

    public BiomeAccessor_1_21_3(Holder<Biome> biomeHolder) {
        this(biomeHolder, fetchNmsBiomeData(biomeHolder));
    }

    public BiomeAccessor_1_21_3(Holder<Biome> biomeHolder, BiomeData cachedData) {
        super(biomeHolder, biomeHolder.value(), cachedData);
    }

    public BiomeAccessor_1_21_3(Biome biome, BiomeData cachedData) {
