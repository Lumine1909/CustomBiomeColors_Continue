...
public class NmsBiome_1_20_5 extends NmsBiome<Biome, Holder<Biome>, ResourceKey<Biome>> {

    public NmsBiome_1_20_5(Holder<Biome> biomeHolder) {
        this(biomeHolder, fetchNmsBiomeData(biomeHolder));
    }

    public NmsBiome_1_20_5(Holder<Biome> biomeHolder, BiomeData cachedData) {
    ...
    public NmsBiome<Biome, Holder<Biome>, ResourceKey<Biome>> cloneWithDifferentColor(NmsServer<Biome, Holder<Biome>, ResourceKey<Biome>> nmsServer, BiomeKey newBiomeKey, ColorData colorData) {
        ResourceKey<Biome> customBiomeKey = ResourceKey.create(Registries.BIOME, new ResourceLocation(newBiomeKey.key(), newBiomeKey.value()));
        ...
        return new NmsBiome_1_20_5(holder, new BiomeData(newBiomeKey, this.cachedData.baseBiomeKey(), colorData));
    }
