...
public class NmsBiome_1_20_5 implements NmsBiome {

    private final Biome biomeBase;

    public NmsBiome_1_20_5(Biome biomeBase) {
    ...
    public NmsBiome cloneWithDifferentColors(NmsServer nmsServer, BiomeKey newBiomeKey, BiomeColors biomeColors) {
        ResourceKey<Biome> customBiomeKey = ResourceKey.create(Registries.BIOME, ResourceLocation.tryBuild(newBiomeKey.key, newBiomeKey.value));
        ...
        return new NmsBiome_1_20_5(customBiome);
    }

    public boolean equals(Object object) {
        return object instanceof NmsBiome_1_20_5 && ((NmsBiome_1_20_5) object).getBiomeBase().equals(this.biomeBase);
    }
}