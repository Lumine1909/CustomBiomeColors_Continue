...
public class NmsBiome_1_20_5 implements NmsBiome<Biome, Holder<Biome>, ResourceKey<Biome>> {

    private final Holder<Biome> biomeHolder;

    public NmsBiome_1_20_5(Holder<Biome> biomeBase) {
    ...
    public NmsBiome<Biome, Holder<Biome>, ResourceKey<Biome>> cloneWithDifferentColors(NmsServer<Biome, Holder<Biome>, ResourceKey<Biome>> nmsServer, BiomeKey newBiomeKey, BiomeColors biomeColors) {
        ...
        return new NmsBiome_1_20_5(holder);
    }

    public boolean equals(Object object) {
        return object instanceof NmsBiome_1_20_5 && ((NmsBiome_1_20_5) object).getBiome().equals(getBiome());
    }
}